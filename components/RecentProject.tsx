    ...
    <div className='py-20' id='projects'>
        ...
        <div className='flex flex-wrap justify-center items-center p-4 gap-x-36 gap-y-4 mt-10 '>
            {projects.map(({id,title,des,img,iconLists,link})=>(
                <div key={id} className='lg:min-h-[30.5rem] sm:h-[38rem] h-[28rem] flex justify-center items-center sm:w-[480px] w-[80vw]'>
                    <PinContainer href={link}>
                        <div className='relative flex justify-center bg-[#04071D] overflow-hidden rounded-lg items-center mb-5 sm:w-[520px] sm:h-[38vh] w-[80vw] h-[30vh] '>
                        ...
                        <h2 className='font-bold lg:text-2xl md:text-xl text-base line-clamp-1 mt-10'>
                            {title}
                        </h2>
